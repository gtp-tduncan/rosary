...
class HomeComponent {
    ...
    onSwipe(event) {
        ...
        this.onNext();
        console.log(`HomeComponent - 2) swipe: ${event === null || event === void 0 ? void 0 : event.direction}`);
    }
}
