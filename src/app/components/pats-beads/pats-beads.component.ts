...
export class PatsBeadsComponent implements OnInit, OnChanges, RosaryBeads {
  ...
  calcImageWidth(): string {
    const imageWidth = (window.innerHeight - 100).toString() + 'px';
    console.log(`imageWidth: ${imageWidth}`);
    return imageWidth;
  }

  calculateHighlightPosition() {
    console.log('calculateHighlightPosition');
    ...
    console.log(`highlight - left: ${this.highlightLeft}, right: ${this.highlightRight}, width: ${this.imageWidth}`);
    console.log(`highlight - left: ${this.highlightLeft}, right: ${this.highlightRight}, width: ${this.imageWidth}`);
  }

  highlightStyle(): string {
    if (this.highlightTop && this.highlightRight) {
      console.log(`highlightStyle => top: ${this.highlightTop}; right: ${this.highlightRight}; height: ${this.highlightDiameter}px; width: ${this.highlightDiameter}px`);
      return `top: ${this.highlightTop}; right: ${this.highlightRight}; height: ${this.highlightDiameter}px; width: ${this.highlightDiameter}px`;
    }
    console.log('highlightStyle => undefined');
    return undefined;
  }
